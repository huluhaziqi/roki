 ...
 */
public class ImageWheelView extends View {
    /**
     * 选择监听
     */
     ...
     * 设置图片id
     */
    private List<Integer> imageList = Lists.newArrayList();
    /**
     * 按下的坐标
     */
    private int downY;
...
//        drawLine(canvas);
    ...
    private void initData() {
        ...
        dataList.add("蹄筋");
        dataList.add("解冻");
        imageList.add(R.mipmap.img_steam_meat_no);
        imageList.add(R.mipmap.img_steam_vege_no);
        imageList.add(R.mipmap.img_steam_egg_no);
        imageList.add(R.mipmap.img_steam_seafood_no);
        imageList.add(R.mipmap.img_steam_cake_no);
        imageList.add(R.mipmap.img_steam_noddle_no);
        imageList.add(R.mipmap.img_steam_tijin_no);
        imageList.add(R.mipmap.img_steam_unfreeze_no);
        itemList.clear();
        for (int i = 0; i < dataList.size(); i++) {
            ...
            itmItemObject.resId = imageList.get(i);
            itmItemObject.x = 0;
...
//        setData(data);
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            // 绘制内容
            Bitmap bitmap = BitmapUtils.decodeSampledBitmapFromResource(getContext(), resId, 111, 91);
