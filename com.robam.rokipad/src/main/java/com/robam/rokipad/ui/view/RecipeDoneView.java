 ...
 */
public class RecipeDoneView extends FrameLayout {
    ...
    public RecipeDoneView(Context context) {
        super(context);
        init(context, null);
    }

    public RecipeDoneView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RecipeDoneView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        View view = LayoutInflater.from(context).inflate(R.layout.view_recipe_done, this, true);
