...
public class DeviceOvenModeWheel extends View {
    ...
    private int chooseRes(int i, boolean isSelected) {
        ...
        switch (i) {
            case 0:
                ans = isSelected ? R.mipmap.img_device_oven_quick_heating_selected : R.mipmap.img_device_oven_quick_heating_unselected;
                break;
            case 1:
                ans = isSelected ? R.mipmap.img_device_oven_air_baking_selected : R.mipmap.img_device_oven_air_baking_unselected;
                break;
            case 2:
                ans = isSelected ? R.mipmap.img_device_oven_toast_selected : R.mipmap.img_device_oven_toast_unselected;
                break;
            case 3:
                ans = isSelected ? R.mipmap.img_device_oven_bottom_heating_selected : R.mipmap.img_device_oven_bottom_heating_unselected;
                break;
            case 4:
                ans = isSelected ? R.mipmap.img_device_oven_unfreeze_selected : R.mipmap.img_device_oven_unfreeze_unselected;
                break;
            case 5:
                ans = isSelected ? R.mipmap.img_device_oven_air_barbecue_selected : R.mipmap.img_device_oven_air_barbecue_unselected;
                break;
            case 6:
                ans = isSelected ? R.mipmap.img_device_oven_strong_barbecue_selected : R.mipmap.img_device_oven_strong_barbecue_unselected;
                break;
            case 7:
                ans = isSelected ? R.mipmap.img_device_oven_barbecue_selected_selected : R.mipmap.img_device_oven_barbecue_selected_unselected;
                break;
        }
        return ans;
    }
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            canvas.drawBitmap(bitmap, x + 40, y + 5 + move, null);
