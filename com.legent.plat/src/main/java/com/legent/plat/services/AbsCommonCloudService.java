...
abstract public class AbsCommonCloudService extends AbsService {
    ...
    public String getAppGuid(String appType, String token) {
        return CloudHelper.getAppGuid(appType, token);
    }

    public void getAppGuid(String appType, String token,
                           Callback<String> callback) {
        CloudHelper.getAppGuid(appType, token, callback);
    }
