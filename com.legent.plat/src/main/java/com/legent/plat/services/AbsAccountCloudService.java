...
abstract public class AbsAccountCloudService extends AbsService {
    ...
    public void registByPhone(String phone, String nickname, String password,
        ...
        CloudHelper.registByPhone(phone, nickname, password, figure, gender,
                verifyCode, callback);
    }
    ...
    protected void bind3rd(long userId, int platType, String thirdId,
                        String nickname, VoidCallback callback) {
        CloudHelper.bind3rd(userId, platType, thirdId, nickname, callback);
    }

    protected void unbind3rd(long userId, int platType, VoidCallback callback) {
        CloudHelper.unbind3rd(userId, platType, callback);
    }
