...
public class EasyLink23 implements IEasyLink {
    ...
    protected void sendSync(String ssid, String key, String user_info)
        ...
        byte[] userinfo = null;
        int userlength = user_info.getBytes("UTF-8").length;
