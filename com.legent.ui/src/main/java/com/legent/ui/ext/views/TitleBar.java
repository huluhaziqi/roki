...
public class TitleBar extends FrameLayout {
    ...
    private void init(Context cx, AttributeSet attrs) {
        ...
        txtTitle = (TextView) titleView.findViewById(R.id.txtTitle);
        pnlLeft = (LinearLayout) titleView.findViewById(R.id.pnlLeft);
        pnlRight = (LinearLayout) titleView.findViewById(R.id.pnlRight);
        pnlMiddle = (RelativeLayout) titleView.findViewById(R.id.pnlMiddle);
