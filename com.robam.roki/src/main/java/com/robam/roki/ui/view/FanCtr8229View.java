...
public class FanCtr8229View extends FrameLayout implements UIListeners.IFanCtrView {
    ...
    void init(Context cx, AttributeSet attrs) {
        ...
        if (!view.isInEditMode()) {
            ...
            gearViews.get(0).setTag(fan.PowerLevel_1);
            gearViews.get(1).setTag(fan.PowerLevel_2);
            gearViews.get(2).setTag(fan.PowerLevel_3);
            gearViews.get(3).setTag(fan.PowerLevel_6);
        ...
        DialogHelper.newDialog_OkCancel(getContext(), null, message, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (i == DialogInterface.BUTTON_POSITIVE) {
                    ...
                    fan.setFanTimeWork((short) (currentFanlevel), (short) 0, new VoidCallback() {
                        @Override
                        public void onSuccess() {
