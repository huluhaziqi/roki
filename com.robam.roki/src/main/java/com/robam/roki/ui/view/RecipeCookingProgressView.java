...
public class RecipeCookingProgressView extends View implements View.OnClickListener {
    ...
    public abstract interface OnCookingStepFinishedCallback {
        void onFinished();
    }
    ...
    public void draw(Canvas c) {
        ...
        if (isFinished) {
            ...
            if (!isInEditMode()) {
                boolean isLastStep = CookTaskService.getInstance().getStepIndex() + 1 == CookTaskService.getInstance().getStepCount();
