...
//            setType(device != null);
    ...
    public void onEvent(SteamOvenStatusChangedEvent event) {
        ...
        relSteam.setBackgroundColor(getResources().getColor(isOn ? R.color.home_bg : R.color.c16));
    }
    ...
    public void setType(boolean hasDevice) {
        relSteam.setBackgroundColor(getResources().getColor(hasDevice ? R.color.c16 : R.color.White));
    ...
    public void setStatus(short status) {
        ...
        switch (status) {
            ...
            case SteamStatus.Off:
                relSteam.setBackgroundColor(getResources().getColor(R.color.c16));
                break;
            default:
                break;
        }
