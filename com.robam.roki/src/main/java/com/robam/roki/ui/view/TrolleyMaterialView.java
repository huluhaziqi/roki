...
public class TrolleyMaterialView extends FrameLayout {
    ...
    static String getMaterialString(Material material) {
        ...
        if (!Strings.isNullOrEmpty(material.w2) && !Strings.isNullOrEmpty(material.u2)) {
            sb.append(material.w2).append(material.u2);
        }
        if (!Strings.isNullOrEmpty(material.w1) && !Strings.isNullOrEmpty(material.u1)) {
            sb.append("(").append(material.w1).append(material.u1).append(")");
        }
        return sb.toString();
    }
}
